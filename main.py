...
if __name__ == '__main__':
    ...
    target_ports = set_ports(args.port, 'tcp')
    ...
    #x = threading.Thread(target=arp_scan(), args=(1,))
    #arguments = [[ifaz, target, tout] for target in targets]
